---
title: "Cryptoverse 2022"
date: 2022-10-23T21:34:46-07:00
draft: false
description: "https://ctftime.org/event/1735/"
---
## Intro
This past weekend, I joined Shellphish for a last minute CTF called Cryptoverse. While I'm still a crypto n00b, I spent a few hours gathering some flags for the team.
...
The ciphertext for this challenge had the distinct appearance of `base64`. After a quick base64 decode, we get the output

```
pipgs{pnrfne_64_sgj}
```

Since the format is correct, perhaps a simple rotation cipher such as `ROT13` will help. This gets us our flag.
...
![cryptomania](/img/cryptomania.png)
...
After connecting, the challenge will prompt the user to guess the city based on IP or Coordinate (as shown below). If you answer if more than 1 second, it's automatically "Wrong."
